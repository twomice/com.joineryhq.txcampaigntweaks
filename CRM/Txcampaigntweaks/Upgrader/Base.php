 ...
 */
class CRM_Txcampaigntweaks_Upgrader_Base {

  /**
   * @var CRM_Txcampaigntweaks_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Txcampaigntweaks_Upgrader(
   ...
   *
   * ```
   * CRM_Txcampaigntweaks_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Txcampaigntweaks_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
